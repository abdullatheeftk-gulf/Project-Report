package com.gulfappdeveloper.projectreport.presentation.screens.sales_screens.screens.user_sales_report_screens.query_screen
...
fun QueryUserSalesReport(
    ...
    LaunchedEffect(key1 = true) {
        salesViewModel.queryUserSalesReportScreenEvent.collectLatest { value ->
            when (value.uiEvent) {
    ...
    Scaffold(snackbarHost = {
        ...
        Column(
            ...
            Row(
                ...
                Button(
                    onClick = {
                       salesViewModel.getUserSalesReport(
