...
private const val TAG = "QueryCustomerPaymentScr"
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun QueryCustomerPaymentScreen(
    ...
    LaunchedEffect(key1 = true) {
        customerPaymentScreenViewModel.queryCustomerPaymentScreenEvent.collectLatest { value ->
            when(value.uiEvent){
                ...
                is UiEvent.Navigate->{
                    Log.d(TAG, "QueryCustomerPaymentScreen: ")
                    customerPaymentNavHostController.navigate(value.uiEvent.route)
                }
    ...
    Scaffold(
        ...
        //contentWindowInsets = WindowInsets(top = 70.dp),
        topBar = {
            TopAppBar(
                title = {
                    Text(
        ...
        Column(
            ...
            Row(
                ...
                Button(
                    onClick = {
                        customerPaymentScreenViewModel.getCustomerPaymentReport(
...
@Preview
@Composable
fun QueryCustomerPaymentScreenPrev() {
