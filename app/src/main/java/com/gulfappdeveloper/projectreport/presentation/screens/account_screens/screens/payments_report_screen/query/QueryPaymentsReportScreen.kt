package com.gulfappdeveloper.projectreport.presentation.screens.account_screens.screens.payments_report_screen.query
...
fun QueryPaymentsReportScreen(
    ...
    Log.i("ScreenWidth", "QueryPaymentsReportScreen: $screenWidth")
    ...
    LaunchedEffect(key1 = true) {
        accountViewModel.queryPaymentsReportScreenEvent.collectLatest { value ->
            when (value.uiEvent) {
    ...
    Scaffold(snackbarHost = {
        ...
        Column(
            ...
            Row(
                ...
                Button(
                    onClick = {
                       accountViewModel.getPaymentsReport(
