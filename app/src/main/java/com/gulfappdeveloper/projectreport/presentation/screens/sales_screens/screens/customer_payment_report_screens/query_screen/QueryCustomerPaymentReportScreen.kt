...
fun QueryCustomerPaymentReportScreen(
    ...
    ClockDialog(
        ...
        selection = ClockSelection.HoursMinutes { hours, minutes ->
            Log.d(TAG, "QueryCustomerPaymentReportScreen: $hours, $minutes")
    ...
    ClockDialog(
        ...
        selection = ClockSelection.HoursMinutes { hours, minutes ->
            Log.e(TAG, "QueryCustomerPaymentReportScreen: $hours, $minutes", )
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                Button(
                    onClick = {
                        salesViewModel.getCustomerPaymentReport(
