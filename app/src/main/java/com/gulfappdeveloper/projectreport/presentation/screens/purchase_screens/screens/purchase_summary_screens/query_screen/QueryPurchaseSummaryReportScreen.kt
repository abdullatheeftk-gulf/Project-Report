package com.gulfappdeveloper.projectreport.presentation.screens.purchase_screens.screens.purchase_summary_screens.query_screen
...
private const val TAG = "QueryPurchaseReportScre"
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun QueryPurchaseSummaryReportScreen(
    ...
    LaunchedEffect(key1 = true) {
        purchaseViewModel.queryPurchaseSummaryReportScreenEvent.collectLatest { value ->
            when (value.uiEvent) {
    ...
    Scaffold(snackbarHost = {
        ...
        Column(
            ...
            Row(
                ...
                Button(
                    onClick = {
                        purchaseViewModel.getPurchaseSummaryReport(
