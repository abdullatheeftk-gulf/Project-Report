...
fun CustomerPaymentReportScreen(
    ...
    val customerPaymentReportTotalList = salesViewModel.customerPaymentReportTotalList
        ...
        topBar = {
            TopAppBar(
                ...
                actions = {
                    ...
                    ScreenOrientationActionForCustomerPayment(
                        salesViewModel = salesViewModel,
                        context = context
                    )
                    Box(
                        ...
                        DropdownMenu(
                            ...
                            DropdownMenuItem(
                                ...
                                onClick = {
                                    salesViewModel.makePdfForCustomerPaymentReport {
                            ...
                            DropdownMenuItem(
                                ...
                                onClick = {
                                    salesViewModel.makeExcelForCustomerPaymentReport {
                                        val shareIntent = Intent().apply {
                                            action = Intent.ACTION_SEND
                                            putExtra(Intent.EXTRA_STREAM, it)
                                            type = "*/*"
