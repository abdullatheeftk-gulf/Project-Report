package com.gulfappdeveloper.projectreport.presentation.screens.purchase_screens.screens.supplier_purchase_screen.report_screen
...
import com.gulfappdeveloper.projectreport.presentation.screens.purchase_screens.screens.supplier_purchase_screen.report_screen.components.SupplierPurchaseReportTable
...
fun SupplierPurchaseReportScreen(
    ...
    val supplierPurchaseReportList = purchaseViewModel.supplierPurchaseReportList
    val supplierPurchaseReportTotals by purchaseViewModel.supplierPurchaseReportTotals
    ...
    LaunchedEffect(key1 = true) {
        purchaseViewModel.supplierPurchaseReportScreenEvent.collectLatest { value ->
            when (value.uiEvent) {
    ...
    Scaffold(
        ...
        Column(
            ...
            if (supplierPurchaseReportList.isEmpty()) {
            ...
            SupplierPurchaseReportTable(
                supplierPurchaseReportList = supplierPurchaseReportList,
                supplierPurchaseReportTotals = supplierPurchaseReportTotals!!
            )
...
@Composable
fun ScreenOrientationActionForSupplierPurchase(
    context: Context,
    purchaseViewModel: PurchaseViewModel
) {
