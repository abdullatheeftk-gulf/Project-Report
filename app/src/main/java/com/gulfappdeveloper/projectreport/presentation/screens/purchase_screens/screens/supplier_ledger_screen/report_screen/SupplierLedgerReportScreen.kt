package com.gulfappdeveloper.projectreport.presentation.screens.purchase_screens.screens.supplier_ledger_screen.report_screen
...
fun SupplierLedgerReportScreen(
    ...
    LaunchedEffect(key1 = true) {
        purchaseViewModel.supplierLedgerReportScreenEvent.collectLatest { value ->
            when (value.uiEvent) {
    ...
    Scaffold(
        ...
        topBar = {
            CenterAlignedTopAppBar(
                ...
                actions = {
                    ScreenOrientationActionForSupplierLedger(
                        context = context,
                        purchaseViewModel = purchaseViewModel
                    )
                    Box(
        ...
        Column(
            ...
            SupplierLedgerReportTable(
                supplierLedgerDetailsList = supplierLedgerReportList,
                supplierLedgerTotals = supplierLedgerReportTotals!!
            )
...
@Composable
fun ScreenOrientationActionForSupplierLedger(
    context: Context,
    purchaseViewModel: PurchaseViewModel
) {
