package com.gulfappdeveloper.projectreport.presentation.screens.purchase_screens.screens.purchase_summary_screens.report_screen
...
@Composable
fun PurchaseSummaryReportScreen(
    ...
    LaunchedEffect(key1 = true) {
        purchaseViewModel.purchaseSummaryReportScreenEvent.collectLatest { value ->
            when (value.uiEvent) {
    ...
    Scaffold(
        ...
        topBar = {
            CenterAlignedTopAppBar(
                ...
                actions = {
                    ScreenOrientationActionForPurchaseSummary(
                        context = context,
                        purchaseViewModel = purchaseViewModel
                    )
                    Box(
                        ...
                        DropdownMenu(
                            ...
                            DropdownMenuItem(
                                ...
                                onClick = {
                                     purchaseViewModel.makePdfForPurchaseSummaryReport {
                            ...
                            DropdownMenuItem(
                                ...
                                onClick = {
                                    purchaseViewModel.makeExcelForPurchaseSummaryReport {
                                        val shareIntent = Intent().apply {
                                            action = Intent.ACTION_SEND
                                            putExtra(Intent.EXTRA_STREAM, it)
        ...
        Column(
            ...
            PurchaseSummaryReportTable(
                purchaseSummaryReportList = purchaseSummaryReportList,
...
@Composable
fun ScreenOrientationActionForPurchaseSummary(
    context: Context,
    purchaseViewModel: PurchaseViewModel
) {
