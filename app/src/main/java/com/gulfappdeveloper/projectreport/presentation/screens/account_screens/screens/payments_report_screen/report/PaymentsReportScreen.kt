package com.gulfappdeveloper.projectreport.presentation.screens.account_screens.screens.payments_report_screen.report
...
fun PaymentsReportScreen(
    ...
    val paymentsReportList = accountViewModel.paymentsReportList
    val paymentReportTotals by accountViewModel.paymentReportListTotals
    ...
    LaunchedEffect(key1 = true) {
        accountViewModel.paymentsReportScreenEvent.collectLatest { value ->
            when (value.uiEvent) {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                ...
                actions = {
                    ScreenOrientationActionForPaymentsReport(
                        context = context,
                        accountViewModel = accountViewModel
                    )
                    Box(
                        ...
                        DropdownMenu(
                            ...
                            DropdownMenuItem(
                                ...
                                onClick = {
                                    accountViewModel.makePdfForPaymentReport {
                            ...
                            DropdownMenuItem(
                                ...
                                onClick = {
                                     accountViewModel.makeExcelForPaymentReport {
                                         val shareIntent = Intent().apply {
                                             action = Intent.ACTION_SEND
                                             putExtra(Intent.EXTRA_STREAM, it)
                                             type =
        ...
        Column(
            ...
            PaymentsReportTable(
                paymentReportList = paymentsReportList,
                paymentReportListTotal = paymentReportTotals
            )
...
@Composable
fun ScreenOrientationActionForPaymentsReport(
    context: Context,
    accountViewModel: AccountViewModel
) {
