...
-keepclassmembers @kotlinx.serialization.Serializable class com.gulfappdeveloper.projectreport.** {
...
# lookup for plugin generated serializable classes
-if @kotlinx.serialization.Serializable class com.gulfappdeveloper.projectreport.**
-keepclassmembers class com.gulfappdeveloper.projectreport.<1>$Companion {
    kotlinx.serialization.KSerializer serializer(...);
}
