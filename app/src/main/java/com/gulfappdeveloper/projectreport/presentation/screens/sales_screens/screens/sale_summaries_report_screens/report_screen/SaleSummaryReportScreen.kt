package com.gulfappdeveloper.projectreport.presentation.screens.sales_screens.screens.sale_summaries_report_screens.report_screen
    ...
    Scaffold(
        ...
        topBar = {
            CenterAlignedTopAppBar(
                ...
                actions = {
                    ScreenOrientationActionForSaleSummary(
                        context = context,
                        salesViewModel = salesViewModel
                    )
                    Box(
...
@Composable
fun ScreenOrientationActionForSaleSummary(
    context: Context,
    salesViewModel: SalesViewModel
) {
