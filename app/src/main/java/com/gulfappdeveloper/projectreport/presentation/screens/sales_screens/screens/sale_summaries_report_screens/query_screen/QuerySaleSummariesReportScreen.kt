package com.gulfappdeveloper.projectreport.presentation.screens.sales_screens.screens.sale_summaries_report_screens.query_screen
...
@Composable
fun QuerySaleSummariesReportScreen(
    ...
    LaunchedEffect(key1 = true) {
        salesViewModel.querySaleSummariesReportScreenEvent.collectLatest { value ->
            when (value.uiEvent) {
    ...
    Scaffold(snackbarHost = {
        ...
        Column(
            ...
            Row(
                ...
                Button(
                    onClick = {
                        salesViewModel.getSaleSummariesReport(
