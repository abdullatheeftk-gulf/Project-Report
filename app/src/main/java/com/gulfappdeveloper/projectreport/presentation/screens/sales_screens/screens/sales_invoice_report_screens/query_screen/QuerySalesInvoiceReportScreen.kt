package com.gulfappdeveloper.projectreport.presentation.screens.sales_screens.screens.sales_invoice_report_screens.query_screen
...
@Composable
fun QuerySalesInvoiceReportScreen(
    ...
    LaunchedEffect(key1 = true) {
        salesViewModel.querySalesInvoiceReportEvent.collectLatest { value ->
            when (value.uiEvent) {
    ...
    Scaffold(snackbarHost = {
        ...
        Column(
            ...
            Row(
                ...
                Button(
                    onClick = {
                        salesViewModel.getSalesInvoiceReport(
