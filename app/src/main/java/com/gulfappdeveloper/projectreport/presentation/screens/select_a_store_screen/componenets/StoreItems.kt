package com.gulfappdeveloper.projectreport.presentation.screens.select_a_store_screen.componenets
...
fun StoreItems(
    ...
    Card(
        ...
        colors = CardDefaults.cardColors(
            containerColor = if (localCompanyData.id == selectedCompanyId) MySecondaryColor else MaterialTheme.colorScheme.surfaceVariant
        )
    ) {
        Row(
            modifier = Modifier
